...
public class Demo {
    public static void main(String[] args) throws InterruptedException {
        ...
        if (scientist1.valuePreparedRobots(robotByScientist1)>scientist2.valuePreparedRobots(robotByScientist2)){
            System.out.println("Учёный №1 победитель!");
        } else{
            System.out.println("Учёный №2 победитель!");
        }
    }
}