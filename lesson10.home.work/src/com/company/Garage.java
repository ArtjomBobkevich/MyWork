...
public class Garage {
    public static void main(String[] args) {
        ...
        map.put(racingCar1,1);
        map.put(racingCar2,1);
        map.put(racingCar3,1);
        map.put(racingCar4,1);
        map.put(civicCar1,1);
        map.put(civicCar2,1);
        map.put(civicCar3,1);
        map.put(civicCar4,1);
        ...
        map.put(cargoCar2,1);
        map.put(cargoCar3,1);
        map.put(militaryCar1,1);
        map.put(militaryCar2,1);
        map.put(militaryCar3,1);
        map.put(militaryCar4,1);
