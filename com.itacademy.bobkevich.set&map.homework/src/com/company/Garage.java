...
public class Garage {
    ...
    public static void main(String[] args) {
        ...
        Car car1 = new RacingCar(Car.Mark.nissan, Car.Model.GTR, 2002, Car.TypeFuel.petrol, 1110);
        ...
        System.out.println(allCarInGarage);
        System.out.println(sortCar(car2, allCarInGarage));
    ...
    public static String sortCar(Car x, Map<Car, Integer> carMap) {
        int valueMark = 0;
        int valueModel = 0;
        int valuefuelType = 0;
        int valueAge = 0;
        ...
        return "Авто данной марки: " + valueMark + " Авто данной модели: " + valueModel + " Авто данного типа топлива: " + valuefuelType + " Авто данного года: " + valueAge + " Авто данной массы: " + valueMass;
    }
}
